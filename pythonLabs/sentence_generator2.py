...
s_nouns = ["A lion", "My friend", "The Emperor", "Some guy", "A cat with rabies", "A bear", "Your homie", "This cool guy my gardener met yesterday", "Namor"]
p_nouns = ["These dudes", "Both of my friends", "All the Emperors of the world", "Some guys", "All of a cattery's cats", "The multitude of bears living under your bed", "Your homies", "Like, these, like, all these people", "Atlanteans"]
...
infinitives = ["to make a pie.", "for no apparent reason.", "because the ocean is poluted.", "for a disease.", "to avenge the kingdom.", "to know more about the surface world."]
